...
public class ThirtyRoundNight5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thirty_round_night5);
        ...
        next_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent next_course = new Intent(ThirtyRoundNight5.this, ThirtyRoundNight5pt2.class);
