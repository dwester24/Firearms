...
import ThirtyRoundDay.ThirtyRoundDaySeven;

public class ThirtyRoundNightActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thirty_round_night);
        ...
        next_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent next_course = new Intent(ThirtyRoundNightActivity.this, ThirtyRoundNight5.class);
