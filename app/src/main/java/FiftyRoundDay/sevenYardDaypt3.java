...
public class sevenYardDaypt3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seven_yard_daypt3);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent sevenYard = new Intent(sevenYardDaypt3.this, sevenYardDaypt4.class);
