...
public class sevenYardDaypt4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seven_yard_daypt4);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent fifteenYard = new Intent(sevenYardDaypt4.this, FiftyRounds15Day.class);
                startActivity(fifteenYard);
            }
        });
