...
import FiftyRoundNight.TenYardpt1;
import FiftyRoundNight.TenYardpt2;

public class ThirtyRoundDayFifteen extends AppCompatActivity {

    private static final long START_TIME_IN_MILLIS = 24000;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thirty_round_day_fifteen);
        ...
        next_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent next_course = new Intent(ThirtyRoundDayFifteen.this, ThirtyRoundDay25.class);
