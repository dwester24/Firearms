...
public class ShotgunDay15pt2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shotgun_day15pt2);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent next_course = new Intent(ShotgunDay15pt2.this, ShotgunDay25.class);
