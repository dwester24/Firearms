...
public class ShotgunDay25 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shotgun_day25);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent next_course = new Intent(ShotgunDay25.this, ShotgunDay40.class);
