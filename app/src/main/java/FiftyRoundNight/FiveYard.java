...
public class FiveYard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_five_yard);

        //Initialize Buttons
        final Button next_button = findViewById(R.id.calculate_button);
        ...
        next_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent next_course = new Intent(FiveYard.this, FiveYardpt2.class);
