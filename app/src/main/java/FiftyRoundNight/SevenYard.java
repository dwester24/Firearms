...
public class SevenYard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seven_yard);
        ...
        next_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent next_course = new Intent(SevenYard.this, TenYardpt1.class);
