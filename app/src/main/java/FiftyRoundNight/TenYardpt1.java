...
public class TenYardpt1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ten_yardpt1);
        ...
        next_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent next_course = new Intent(TenYardpt1.this, TenYardpt2.class);
