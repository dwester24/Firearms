...
public class FiftyRound extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fifty_round);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent homeIntent = new Intent(FiftyRound.this, MainActivity.class);
    ...
    public void finalScore() {
        ...
        double scoreFinal = (fiveScore + fourScore + threeScore) * .4;
